...
//  BasicAppLayout
//
//  Created by Todd Sleeman on 7/2/22.
//

import Foundation

// making URL identifiable
...
class FolderMonitor {
    ...
    private var monitoredFolderFileDescriptor: CInt = -1 // Int32
...
// /*
 class DirectoryMonitor {
     ...
     typealias Delegate = DirectoryMonitorDelegate // Protocol
